...
def write_fake_claude(
    ...
    *,
    ...
    path.write_text(
        ...
        f"    print(json.dumps([{{'id':'codebase-search@redacted-code-intelligence','version':'0.4.12','scope':'user','enabled':True,'installPath':'{install_root}'}}]))\n"
    ...
    events = [
        {
            ...
            "plugins": [
                {"id": "codebase-search@redacted-code-intelligence", "version": "0.4.12"}
            ],
            "mcp_servers": [
